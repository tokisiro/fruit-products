...
class Product_SeasonTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('product_season')->insert([
            ...
            //ブドウ
            ['product_id' => 8, 'season_id' => 2, 'created_at' => now(), 'updated_at' => now()],//夏
            ['product_id' => 8, 'season_id' => 3, 'created_at' => now(), 'updated_at' => now()],//秋
            //バナナ
            ['product_id' => 9, 'season_id' => 2, 'created_at' => now(), 'updated_at' => now()],//夏
            //メロン
            ['product_id' => 10, 'season_id' => 1, 'created_at' => now(), 'updated_at' => now()],//春
            ['product_id' => 10, 'season_id' => 2, 'created_at' => now(), 'updated_at' => now()],//夏
        ]);
    }
}
