...
<body>
    ...
    <main>
        <div class="product">
            <div class="product-sidebar">
                <div class="product-sidebar__search">
                    ...
                    <form action="product-sidebar__search-form">
        ...
        <option value="name_asc" {{ request('sort')=='name_asc' ? 'selected' : '' }}>商品名（昇順）</option>
        <option value="name_desc" {{ request('sort')=='name_desc' ? 'selected' : '' }}>商品名（降順）</option>
    </select>
