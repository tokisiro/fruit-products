        ...
        <div class="change-form__content-image">
            ...
            <div class="change-form__content-season">
                ...
                <div class="change-form__content-season--select">
                    <label><input type="checkbox" name="name" value="{{$change->season_id}}" placeholder="" />春</label>
                    <label><input type="checkbox" name="name" value="{{$change->season_id}}" placeholder="" />夏</label>
                    <label><input type="checkbox" name="name" value="{{$change->season_id}}" placeholder="" />秋</label>
                    <label><input type="checkbox" name="name" value="{{$change->season_id}}" placeholder="" />冬</label>
                </div>
            ...
            <div class="change-form__content-explanation">
                ...
                <input class="change-form__content-explanation--text" type="textarea" name="description" value="{{$change->textarea}}" placeholder="" />
