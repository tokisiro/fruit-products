                ...
                <div class="change-form__content-info">
                    ...
                    <div class="change-form__content-info--season">
                        ...
                        <div class="change-form__content-info--season-select">
                            <label class="change-form__content-info--season-select-label">
                                <input class="change-form__content-info--season-select-label-checkbox"type="checkbox" name="season_id[]" value="1" {{ in_array(1, $products) ? 'checked' : '' }}>
                                春
                            </label>
                            <label class="change-form__content-info--season-select-label">
                                <input class="change-form__content-info--season-select-label-checkbox"type="checkbox" name="season_id[]" value="2" {{ in_array(3, $products) ? 'checked' : '' }}>
                                夏
                            </label>
                            <label class="change-form__content-info--season-select-label">
                                <input class="change-form__content-info--season-select-label-checkbox"type="checkbox" name="season_id[]" value="3" {{ in_array(3, $products) ? 'checked' : '' }}>
                                秋
                            </label>
                            <label class="change-form__content-info--season-select-label">
                                <input class="change-form__content-info--season-select-label-checkbox"type="checkbox" name="season_id[]" value="4" {{ in_array(4, $products) ? 'checked' : '' }}>
                                冬
                            </label>
                        </div>
                        @error('season_id')
                            <div class="change-form__content-info--season-select-label-checkbox">
