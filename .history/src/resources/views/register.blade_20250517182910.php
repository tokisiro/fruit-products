            ...
            @csrf
                ...
                <div class="register-form__image">
                    ...
                    <div class="register-form__image-content">
                        <img class="register-form__image-content--card" src="{{ old('image') }}" alt="フルーツ">
                ...
                <div class="register-form__explanation">
                    ...
                    <textarea  class="register-form__explanation-content-input" type="textarea" name="description" placeholder="商品の説明を入力" value="{{ old('description') }}"/>
                    <div class="register-form__error">
                        @error('description')
                        <div class="register-form__error">
