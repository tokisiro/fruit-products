                ...
                <div class="product-sidebar__form">
                    ...
                    @csrf
                        <div class="product-sidebar__form-search--text">
                            <input class="product-sidebar__form-search-form--text-item" type="text" name="name" placeholder="商品名で検索" value="{{ request('name') }}">
                        </div>
                    ...
                    <form class="product-sidebar__form-sort" action="/products/sort" method="GET" id="sortForm">
                    @csrf
