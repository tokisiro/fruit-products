    ...
    <div class="change-form">
        ...
        <form class="change-form__content" action="/products/{{$change->id}}/update" method="post" enctype="multipart/form-data">
            ...
            <div class="change-form__button">
                ...
                <button class="change-form__button-update" type="submit">変更を保存</button>
            </div>
        </form>
        <form class="change-form__button-delete" action="/products/{{$change->id}}/delete" method="POST">
            @csrf
            <button class="change-form__button-delete--submit">送信</button>
        </form>
    </main>
    <script>
