            ...
            <div class="product-sidebar">
                <div class="product-sidebar__form">
                    ...
                    @csrf
                        ...
                        <span class="product-sidebar__form-search--title">
                            価格順で表示
                        </span>
                        <div class="product-sidebar__form-search--order">
                            <select class="product-sidebar__form-search--order-item" name="sort" onchange="document.getElementById('searchSortForm').submit();">
                                <option value="">
                                    並び替えを選択
                                </option>
