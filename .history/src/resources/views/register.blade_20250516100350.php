    ...
    <main>
        ...
        <form class="register-form" action="/products/register" method="post" enctype="multipart/form-data">
            ...
            <div class="register-form__group">
                ...
                <div class="register-form__group-content">
                    <div class="register-form__input--text">
                        <label><input type="checkbox" name="season_id[]" placeholder="" value="1"/>春</label>
                        <label><input type="checkbox" name="season_id[]" placeholder="" />夏</label>
                        <label><input type="checkbox" name="season_id[]" placeholder="" />秋</label>
                        <label><input type="checkbox" name="season_id[]" placeholder="" />冬</label>
                    </div>
                    <div class="register-form__error">
                        <!--バリデーション機能を実装したら記述します。-->
                        @error('season_id')
