...
<main>
    <div class="change">
            ...
            <div class="change-form__content">
                ...
                <div class="change-form__content-info">
                    <div class="change-form__content-info--name">
                        <span class="change-form__content-info--name-item">商品名</span>
                    ...
                    <div class="change-form__content-info--price">
                        <span class="change-form__content-info--price-item">値段</span>
                    ...
                    <div class="change-form__content-info--season">
                        ...
                        <div class="change-form__content-info--season-select">
                            <label>
                                <input type="checkbox" name="season_id[]" value="1" {{ in_array(1, $products) ? 'checked' : '' }}>
                                春
                            </label>
                            <label>
                                <input type="checkbox" name="season_id[]" value="2" {{ in_array(2, old('season_id', $products->season_id ?? [])) ? 'checked' : '' }}>
                                夏
                            </label>
                            <label>
                                <input type="checkbox" name="season_id[]" value="3" {{ in_array(3, $products) ? 'checked' : '' }}>
                                秋
                            </label>
                            <label>
                                <input type="checkbox" name="season_id[]" value="4" {{ in_array(4, $products) ? 'checked' : '' }}>
                                冬
                            </label>
                        </div>
                        @error('season_id')
        ...
        <form class="change-form__button" action="/products/{{$change->id}}/delete" method="post">
            @method('DELETE')
            @csrf
            <button class="change-form__button-delete--submit">🗑️五御箱</button>
        </form>
    </main>
    <script>
        <script>
