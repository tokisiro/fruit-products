            ...
            @csrf
                <div class="register-form__name">
                    <label class="register-form__name-item">
                        <div class="register-form__name-item--title">商品名</div>
                        <div class="register-form__name-item--required">必須</div>
                        <input class="register-form__name-item--input" type="text" name="name" placeholder="" />
                    </label>
                ...
                <div class="register-form__group">
                    ...
                    <div class="register-form__group-content">
                            <input class="register-form__input--text" type="text" name="price" placeholder="" />
                        <div class="register-form__error">
                ...
                <div class="register-form__group">
                    ...
                    <div class="register-form__group-content">
                            <input  class="register-form__input--text" type="file" accept="image/*" name="image" />
