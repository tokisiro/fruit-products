        ...
        <div class="register-form">
            ...
            @csrf
                ...
                <div class="register-form__explanation">
                    <div class="register-form__explanation-title">
                        <span class="register-form__explanation-title--item">商品説明</span>
                        <span class="register-form__explanation-title-item--required">必須</span>
                    </div>
