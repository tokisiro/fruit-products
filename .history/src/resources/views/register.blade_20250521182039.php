            ...
            @csrf
                <div class="register-form__name">
                    ...
                    <div class="register-form__name-error">
                        @error('name')
                            <div class="register-form__name-error--item">
                                {{$errors->first('name')}}
                            </div>
                        @enderror
                    </div>
                ...
                <div class="register-form__price">
                    ...
                    <input class="register-form__price-input" type="text" name="price" placeholder="値段を入力" value="{{ old('price') }}"/>
                ...
                <div class="register-form__image">
                    ...
                    <div class="register-form__image-content">
                        <img class="register-form__image-content--card" id="imagePreview" alt="フルーツ" style="display:none";>
                        <input  class="register-form__image-content--file" type="file"  name="image" onchange="previewImage(event)"/>
                        <div class="register-form__image-content--error">
                        @error('image')
                            <div class="register-form__image-content--error-item">
                                {{$errors->first('image')}}
                            </div>
                        @enderror
                        </div>
                ...
                <div class="register-form__season">
                    <label class="register-form__season-item">
                        <span class="register-form__season-item--title">
                            季節
                        </span>
                        <span class="register-form__season-item--required">
                            必須
                        </span>
                        <span class="register-form__season-item--multiple">
                            複数選択可
                        </span>
                    </label>
                    <div class="register-form__season-content">
                        <div class="register-form__season-content--input">
                            <label class="register-form__season-content--input-item"><input class="register-form__season-content--input-checkbox" type="checkbox" name="season_id[]"  value="1"/>
                                春
                            </label>
                            <label class="register-form__season-content--input-item"><input class="register-form__season-content--input-checkbox" type="checkbox" name="season_id[]" value="2"/>
                                夏
                            </label>
                            <label class="register-form__season-content--input-item"><input class="register-form__season-content--input-checkbox" type="checkbox" name="season_id[]" value="3" />
                                秋
                            </label>
                            <label class="register-form__season-content--input-item"><input class="register-form__season-content--input-checkbox" type="checkbox" name="season_id[]" value="4"/>
                                冬
                            </label>
                        </div>
                ...
                <div class="register-form__explanation">
                    <label class="register-form__explanation-item">
                        <span class="register-form__explanation-item--title">
                            商品説明
                        </span>
                        <span class="register-form__explanation-item--required">
                            必須
                        </span>
                    </label>
                    <textarea  class="register-form__explanation-content" name="description" placeholder="商品の説明を入力" value=""></textarea>
