        ...
        <div class="register-form">
            ...
            @csrf
                <div class="register-form__name">
                    ...
                    <input class="register-form__name-input" type="text" name="name" placeholder="商品名を入力" />
                ...
                <div class="register-form__price">
                    ...
                    <input class="register-form__price-input" type="text" name="price" placeholder="値段を入力" />
                        <div class="register-form__error">
                ...
                <div class="register-form__season">
                    ...
                    <div class="register-form__season-content">
                        <div class="register-form__season-content--input">
                            <label class="register-form__season-content--input-"><input type="checkbox" name="season_id[]"  value="1"/>春</label>
                        ...
                        <div class="register-form__error">
                            <!--バリデーション機能を実装したら記述します。-->
                            @error('season_id')
                            <div    class="change-form__error-content">
                ...
                <div class="register-form__explanation">
                    ...
                    <input  class="register-form__explanation-content-input" type="textarea" name="description" placeholder="" />
                    <div class="register-form__error">
                        <!--バリデーション機能を実装したら記述します。-->
                        @error('description')
                        <div class="register-form__error">
