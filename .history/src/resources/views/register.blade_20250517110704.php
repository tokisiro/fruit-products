        ...
        <div class="register-form">
            ...
            @csrf
                <div class="register-form__name">
                    <label>
                        <div class="register-form__name-title">商品名</div>
                        <div class="register-form__name-Required">必須</div>
                        <input class="register-form__group-input--text" type="text" name="name" placeholder="" />
                    </label>
