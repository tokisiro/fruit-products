            ...
            @csrf
                ...
                <div class="register-form__price">
                    ...
                    <input class="register-form__price-input" type="text" name="price" placeholder="値段を入力" value="{{ old('price') }}"/>
                        <div class="register-form__error">
                            ...
                            @error('prise')
                            <div class="change-form__price-error">
                                {{$errors->first('price')}}
                            </div>
                            @enderror
                        </div>
                ...
                <div class="register-form__image">
                    ...
                    <div class="register-form__image-content">
                        ...
                        <input  class="register-form__image-content--file" type="file" accept="image/*" name="image" onchange="previewImage(event)"/>
                        <div class="register-form__error">
                            <!--バリデーション機能を実装したら記述します。-->
                            @error('image')
                ...
                <div class="register-form__season">
                    ...
                    <div class="register-form__season-content">
                        ...
                        <div class="register-form__seasoncontent-error">
                            <!--バリデーション機能を実装したら記述します。-->
                            @error('season_id')
