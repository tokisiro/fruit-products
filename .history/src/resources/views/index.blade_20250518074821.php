    ...
    <div class="change">
        <div class="change-header">
            <p class="change-header__text">
                <a class="change-header__text" href="/products">商品一覧</a>>{{$change->name}}
            </p>
        </div>
        ...
        @method('PATCH')
            ...
            <div class="change-form__content-bottom">
                <div class="change-form__content-bottom--explanation">
                    ...
                    <textarea class="change-form__content-bottom--explanation-text" name="description" value="{{ old('description', $change->description) }}" placeholder=""></textarea>
                    @error('description')
