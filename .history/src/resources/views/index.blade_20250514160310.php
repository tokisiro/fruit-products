        ...
        <form class="change-form__content" action="/products/{{$change->id}}/update" method="post" enctype="multipart/form-data">
            ...
            <div class="change-form__content-season">
                ...
                <div class="change-form__content-season--select">
                    <label><input type="checkbox" name="season_id[]" value="{{$products->season_id}}" placeholder="" />春</label>
                    <label><input type="checkbox" name="season_id[]" value="{{$products->season_id}}" placeholder="" />夏</label>
                    <label><input type="checkbox" name="season_id[]" value="{{$products->season_id}}" placeholder="" />秋</label>
                    <label><input type="checkbox" name="season_id[]" value="{{$products->season_id}}" placeholder="" />冬</label>
                </div>
                @error('season_id')
