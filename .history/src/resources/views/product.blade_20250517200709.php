    ...
    <main>
        <div class="layout-container">
            <div class="sidebar">
                ...
                <div class="product__content-button" style="margin-top: 20px;">
                    <a class="product__content-button-item" href="/register">+ 商品を追加</a>
                </div>
            </div>
                <!-- 右側：商品カードリスト -->
            <div class="card-area">
                        ...
                        <div class="product__card-form--img">
                            <button type="submit" style="border: none; padding: 0; background: none; cursor: pointer;">
                                ...
                                <div class="product__card-form--content">
                                    <div class="product__card-form--content-name">{{$product->name}}</div>
                                        <div class="product__card-form--content-price">{{$product->price}</div>
                                </div>
                            </button>
          </div>
        </form>
