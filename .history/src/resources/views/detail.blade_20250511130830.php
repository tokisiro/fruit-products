...
<header class="header">
    ...
    <main>
        <div class="register-form__content">
            <p><a href="">商品一覧</a>>value="{{$form->name}}"</p>
        </div>
        <form class="register-form" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="register-form__group">
                ...
                <div class="register-form__group-content">
                    <div class="register-form__input--text">
                        ...
                        <label><input type="checkbox" name="name" placeholder="" value="{{$form->name}}"/>冬</label>
                    </div>
                    <div class="register-form__error">
                        <!--バリデーション機能を実装したら記述します。-->
                    </div>
            ...
            <div class="register-form__group">
                ...
                <div class="register-form__group-content">
                    <div class="register-form__input--text">
                        <input type="textarea" name="description" placeholder="" value="{{$form->description}}"/>
                    </div>
                    <div class="register-form__error">
                        <!--バリデーション機能を実装したら記述します。-->
                    </div>
