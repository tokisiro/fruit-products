                ...
                <div class="change-form__content-info">
                    ...
                    <div class="change-form__content-info--season">
                        ...
                        <div class="change-form__content-info--season-select">
                            ...
                            <label>
                                <input type="checkbox" name="season_id[]" value="2" {{ in_array(2, old('season_id', $products->season_id ?? [])) ? 'checked' : '' }}>夏</label>
                            <label><input type="checkbox" name="season_id[]" value="3" {{ in_array(3, $products) ? 'checked' : '' }}>秋</label>
                            <label><input type="checkbox" name="season_id[]" value="4" {{ in_array(4, $products) ? 'checked' : '' }}>冬</label>
                        </div>
                        @error('season_id')
